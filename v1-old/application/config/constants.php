...
define('SMS_API_URL', 'http://sms.technixindia.com/http-api.php?username=BIHPCB&password=bihPcb@123&senderid=BIHPCB&route=1');


//define('GOOGLE_MAP_KEY', 'AIzaSyD3EJban2lt-dIWtos_zRR9xSywNhyZuQY');

if($_SERVER['SERVER_NAME'] === 'localhost') {
	$GOOGLE_MAP_KEY = 'AIzaSyD1n8dlv79iiCOFF096QlUzQtUFeuwSsTM';
} else {
	// $GOOGLE_MAP_KEY = 'AIzaSyD3EJban2lt-dIWtos_zRR9xSywNhyZuQY';
    $GOOGLE_MAP_KEY = 'AIzaSyCbHNArVTYIXdAi7MTJW5ofM9xSZ-yuRGk';
}
