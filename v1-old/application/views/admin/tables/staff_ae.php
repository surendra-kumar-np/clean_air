...
$result  = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, ['GROUP_CONCAT( region.region_name SEPARATOR ", ") as sr_name','staffid', 'area', 'region', 'sub_region', 'roles.slug_url'], 'GROUP BY staffid');
