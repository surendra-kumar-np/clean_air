										...
										<div class="col-md-3">
											<div class="form-group" app-field-wrapper="clients">
												<div class="form-select-field">
													...
													echo '<div id="leads-filter-status">';
													echo render_select('clients[]', $clients, array('userid', 'company'), '', $selected, array('data-width' => '100%', 'data-none-selected-text' => 'Surveyor', 'multiple' => true, 'data-actions-box' => true), array(), 'no-mbot', '', false);
													echo '</div>';
													?>
