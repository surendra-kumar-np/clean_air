...
<body>
    ...
    <?php if ($GLOBALS['current_user']->role_slug_url == "ae-global") { ?>
        <h2 class="text-center">Summary of India<?php echo (!empty($tableParams['area_name'])) ? ", " . $tableParams['area_name'] : ''; ?></h2>
        <span class="generated mB5"><?php echo $summ;  ?></span>
    <?php } else { ?>
        <h2 class="text-center">Summary of <?php echo !empty($GLOBALS['current_user']->location['area']) ? $GLOBALS['current_user']->location['area'] : 'India' ?></h2>
        <span class="generated mB5"><?php echo $summ;  ?></span>
    <?php } ?>
                            ...
                            foreach ($val["region_status"] as $status) { ?>
                                ...
                                <?php if (!empty($status["sub_region_status"])) {
                                    foreach ($status["sub_region_status"] as $sub_status) { ?>
                                        <tr class="subregion">
                                            <td class="text-left"><?php echo $sub_status["sub_region_name"] ?></td>
