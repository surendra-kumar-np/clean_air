...
<div class="modal fade sidebarModal dash-filter" id="modify_filter_modal" tabindex="-1" role="dialog" style="width:40%">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <?php echo form_open(admin_url('dashboard/index')); ?>
         ...
         <div class="modal-footer">
            <button type="submit" id="search_id" class="btn btn-custom">Apply</button>
