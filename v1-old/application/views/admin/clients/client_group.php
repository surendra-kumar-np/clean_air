    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button group="button" class="btn btn-custom" data-dismiss="modal"><?php echo _l('close'); ?></button>
                <button group="submit" class="btn btn-cancel"><?php echo _l('submit'); ?></button>
                <?php echo form_close(); ?>
            </div>
        </div>
    </div>
