...
function render_input($name, $label = '', $value = '', $type = 'text', $input_attrs = [], $form_group_attr = [], $form_group_class = '', $input_class = '')
{
    ...
    */
    ...
    $input .= '<div class="form-input-field">';

    $input .= '<input ' . $_input_attrs . ' class="'. $input_class .'" type="' . $type . '" required="" id="' . $name . '" name="' . $name . '" value="' . set_value($name, $value) . '">';
    if ($label != '') {
        $input .= '<label for="' . $name . '" title="' . _l($label, '', false) . '" data-title="' . _l($label, '', false) . '"></label>';
    }
    $input .= '</div>';

    /*$input .= '<div class="form-input-field">
        <input type="text" required="" autocomplete="off" id="admin-name" name="firstname">
         <label for="admin-name" title="Action Enforcers Name*" data-title="Action Enforcers Name*"></label>
     </div>';
*/
 ...
 */
// 
function render_select_surveyor($name, $options, $option_attrs = [], $label = '', $selected = '', $select_attrs = [], $form_group_attr = [], $form_group_class = '', $select_class = '', $include_blank = true)
{
    $callback_translate = '';
    ...
    $select .= '<select  name="' . $name . '" class="selectpicker' . $select_class . '" ' . $_select_attrs . ' data-live-search="true">';
