...
class CitizensController extends App_Controller
{
    public $template = [];
	...
	public function project_layout($notInThemeViewFiles = false)
    {
        /**
         * Navigation and submenu
         * @deprecated 2.3.2
        ...
        $this->data['use_navigation'] = $this->use_navigation == false;
        $this->data['use_submenu']    = $this->use_submenu == true;
     ...
     * Sets view data
     * @param  array $data
     * @return core/CitizensController
     */
