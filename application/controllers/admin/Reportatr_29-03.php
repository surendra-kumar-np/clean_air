...
$region = !empty($post_data['region']) ? $post_data['region'] : $area;
        ...
        if ($role_slug == 'ae-global') {
            ...
            $data['title']         = $siteTitle[$role_slug];
            if($role!=6){
                $data['action_taker'] = $this->atr_report_model->get_action_taker($area, $wardid,$staffid);
                
            }else{
                $data['action_taker'] = $this->atr_report_model->get_action_taker($area, $wardid);
            ...
            if($role!=6){
                if($role==4){
                    ...
                    $data['projectsupport'] = $this->atr_report_model->get_project_support('','','',$plStaffId);
                    $dataprojectsupport = $this->atr_report_model->get_project_support('','','',$plStaffId);
                    ...
                    $data['projectsupport'] = $this->atr_report_model->get_project_support('','','',$staffid);
                ...
                $data['projectsupport'] = $this->atr_report_model->get_project_support($area); 
