...
class Reportatr extends AdminController
{
    ...
    public function index()
    {
       ...
       // pre($post_data);
        ...
        $areaid = (!empty($post_data['areaid'])) ? $post_data['areaid'] : '';
        $regionid = (!empty($post_data['region'])) ? $post_data['region'] : '';
        $subregionid = (!empty($post_data['subregion'])) ? $post_data['region'] : '';
    ...
    public function get_atr_projects() {
        ...
        echo json_encode( ['draw' => $post_data['draw'], 'recordsTotal' => $project_count, 'recordsFiltered' => $project_count, 'data' => $projects_data_array] );
        exit;
