...
// Aliases for short routes (Citizens)
$route['citizens_reset_password']  = 'citizensauthentication/reset_password';
$route['citizens_forgot_password'] = 'citizensauthentication/forgot_password';
$route['citizens_login']           = 'citizensauthentication/login';
$route['citizens_logout']          = 'citizensauthentication/logout';
$route['citizens_register']        = 'citizensauthentication/register';
$route['citizens_emailverification']        = 'citizensauthentication/email_verification_keys';
$route['verification/verify/(:num)/(:any)']           = 'citizensauthentication/verify';
...
$route['authentication/gentr'] = 'admin/authentication/gentr';
