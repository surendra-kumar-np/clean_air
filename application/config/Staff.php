...
class Staff extends AdminController
{
    ...
    public function index()
    {
        ...
        $tableView = ["ae-global" => "staff", "ae-area" => "staff_ae", "aa" => "staff", "ar" => "staff_ar", "at" => "staff_at", "ata" => "staff_ata","org" => "staff_org"];
        $siteTitle = ["ae-global" => "National Observers", "ae-area" => "State Observer", "aa" => "State Admins", "ar" => "Reviewer", "at" => "Project Leader", "ata" => "Project Support","org" => "Organization"];
    ...
    public function edit_profile()
    {
        if ($this->input->post()) {
			...
			$this->form_validation->set_rules('firstname', 'Firstname', 'required|alpha_numeric_input|max_length[155]');
            $this->form_validation->set_rules('organisation', 'Organisation', 'required|alpha_numeric_input|max_length[155]');
...
// sms api
    ...
    public function save_area_enforcer()
    {
        ...
        if ($this->input->post()) {
			...
			$this->form_validation->set_rules('firstname', 'Name', 'trim|alpha_numeric_spaces|max_length[50]|required');
