...
$config['sess_expiration']         = (defined('APP_SESSION_EXPIRATION') ? APP_SESSION_EXPIRATION : 900);
$config['sess_save_path']          = SESS_SAVE_PATH;
$config['sess_match_ip']           = true;//(defined('APP_SESSION_MATCH_IP') ? APP_SESSION_MATCH_IP : false);
...
$config['department_id'] = isset($_GET['department_id']) ? $_GET['department_id'] : null;


//Reference: https://onlinewebtutorblog.com/session-fixation-session-hijacking-attack-in-codeigniter/
...
//https://stackoverflow.com/questions/52061469/codeigniter-session-resets-when-refreshing

$config['cookie_domain']    = '';//'.caap-patna.com';
$config['cookie_path']      = '/';
$config['cookie_secure']    = false;//true
$config['cookie_httponly']  = false;//true
$config['cookie_lifetime']  = time() + (86400 * 30);
...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'api\/.+', 'admin/issues_manage', 'admin/issues/validate', 'admin/issues/newissue', 'admin/issues/change_issue_status', 'admin/dashboard/load_sub_dashboard', 'admin/dashboard/get_chart_data', 'admin/report/get_subregion', 'admin/dashboard/mapview_ajax', 'admin/issues/get_duration_issues', 'admin/projects/get_project_activity', 'admin/dashboard/action_items', 'admin/tickets/ticket_details', 'admin/tickets/assign_ticket', 'admin/tickets/reject_ticket', 'admin/tickets/update_milestone', 'admin/region', 'admin/subregion', 'admin/region/get_region', 'admin/staff/get_staff_region', 'admin/staff', 'admin/staff/get_action_taker', 'admin/staff/get_action_takers', 'admin/staff/get_staff_detail', 'admin/staff/get_staff_issues', 'admin/staff/get_area_reviewers', 'admin/issues/get_area_issues', 'admin/staff/get_ata', 'clients/get_surveyor_detail', 'clients/get_region', 'clients/getsubregion', 'clients/get_area_issues', 'clients/check_geotagg_image', 'citizens/get_surveyor_detail', 'citizens/get_region', 'citizens/getsubregion', 'citizens/get_area_issues', 'citizens/check_geotagg_image' ];
...
/* Captcha settings */
//$config['captcha_number_only']	= rand(100000, 999999);

//$config['captcha_font_path']	= 'assets/fontCaptcha/times_normal.ttf';

$config['captcha_word']         = '';
$config['captcha_expiration']   = 7200;
$config['captcha_img_id']       = 'Imageid';
$config['captcha_pool']         = '23456789ABCDEFGHJKLMNPQRSTVWXYZ';

$config['captcha_img_path']		= 'assets/captcha_image/';
$config['captcha_img_height']	= 40;
$config['captcha_img_width']	= 120;
$config['captcha_word_length']	= 6;
$config['captcha_font_size']	= 12;
$config['captcha_font_colors']	= array(
										'background'    => array(255,255,255),
										'border'        => array(255,255,255),
										'text'          => array(0,0,0),
										'grid'          => array(245, 245, 255)
									);
