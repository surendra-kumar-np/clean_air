...
<nav class="navbar navbar-default header">
   <div class="container">
      ...
      <p class="product-name pull-left"><?php echo get_option('companyname');?></p>
                  ...
                  <ul class="dropdown-menu animated fadeIn">
                     ...
                     <li class="customers-nav-item-company-info">
                           <a href="<?php echo site_url('clients/open_ticket'); ?>">
                              <?php echo _l('Raise Project'); ?>
                           </a>
                           <?php if(!is_callcenter($this->session->userdata('client_user_id'))){?>
                              <a href="<?php echo site_url('clients/projects'); ?>">
                              <?php echo _l('View Raised Projects'); ?>
                           <?php }?>
                           </a>
                        </li>
