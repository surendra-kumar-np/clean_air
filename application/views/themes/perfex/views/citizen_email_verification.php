...
<?php echo form_open($this->uri->uri_string(), ['id' => 'email-verification-form']); ?>
			...
			<div class="login-form">
				<div class="row mB0">
					<div class="form-group">
						<h1>
							<i class="text-uppercase mB0"><?php echo _l('Email Verification'); ?></i>
							<span>Enter your registered email id, We will send you the email verification link.</span>
						</h1>
				...
				<div class="row">
					...
					<div class="form-field">
						<button type="submit" class="btn btn-info btn-block showLoader">Submit</button>
					</div>
...
<script>
	...
	$("form#email-verification-form :input").each(function() {
		if ($(this).val()) {
