      ...
      <div class="login-form">
        ...
        <div class="row">
			<div class="form-input-field mB15 mT10">
				<?php echo render_input('email', 'customer_forgot_password_email', set_value('email'), 'email', array('maxlength' => 50) ); ?>
			...
			<div class="input-field mT20">
				<span class="d-block text-center font12" style="color: #314e73">Back to login ? Click <a href="<?php echo site_url('login/'); ?>">here</a></span>
			</div>
...
<script>
    ...
    $(document).ready(function(){
		...
		$('.captcha-refresh').on('click', function(){
			$.get('<?php echo base_url(); ?>authentication/refreshcaptcha', function(data){
