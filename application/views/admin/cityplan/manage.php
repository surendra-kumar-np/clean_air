                ...
                <div class="panel_s custom-panel1">
                    <div class="panel-body">
                        <div class="panel-header">
                            ...
                            <?php echo _l('add_cityplan'); ?>
                            </a>

                            <h1><?php echo _l('manage_city'); ?><span><?php echo _l('here_you_can_view_add_edit_and_deactivate_cityplan'); ?> </span></h1>
...
<div class="modal fade sidebarModal" id="department" tabindex="-1" role="dialog" style="width:40%">
    <div class="modal-dialog">
        <?php echo form_open_multipart(admin_url('cityplan/area'), array('id' => 'area_form')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('edit_cityplan'); ?></span>
                    <span class="add-title"><?php echo _l('new_cityplan'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div id="addition"></div>
                        <p class="form-instruction add-title"><?php echo _l('fill_in_the_following_fields_to_add_a_cityplan'); ?></p>
                        <p class="form-instruction edit-title"><?php _l('fill_in_the_following_field_to_edit_a_cityplan'); ?></p>
                    </div>
                    <hr class="hr-panel-model" />
                </div>

                <div class="form-group">
                <?php $staffid = $GLOBALS['current_user']->staffid; ?>
                    <?php echo render_input('name', 'client_city'); ?>
                    <?php echo form_hidden('staffid',$staffid);?>
                </div>
    ...
    <script>
        ...
        const changeStatus = (invoker, id) => {
            ...
            let url = admin_url + "cityplan/change_area_status";
            let data = {};
