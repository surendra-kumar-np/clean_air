                ...
                <div class="panel_s custom-panel1">
                    <div class="panel-body">
                        <div class="panel-header">
                            <h1><?php echo _l("edit_city_action_plan");?><span><?php echo _l('here_you_can_edit_city_action_plan'); ?></span></h1>
                            ...
                            <?php echo form_open_multipart('admin/masterplan/edit',array('id'=>'open-new-ticket-form')); ?>
                                <div class="col-md-6">
                                    <div class="form-input-field mB15">
                                        <div for="attachment" class="mB5"><?php echo _l('city_action_plan'); ?><span style="font-size:12px;">&nbsp;<?php echo _l('select_pdf_only_max_size_5mb_req'); ?> </span></div>
                                        <div>
                                        <input type="file" name="file" id="pdf" class="form-control">
                                        <label for="attachment" title="" data-title=""></label>
                                        </div>
                                    </div>
                                <button type="submit" class="btn btn-custom btn-primary"><?php echo _l('submit');?> </button>
                                <button type="reset" class="btn btn-cancel manage-btn mL5" ><?php echo _l('reset'); ?></button>
                                </div>
                            <?php echo form_close(); ?>
                            </div>
                    </div>
