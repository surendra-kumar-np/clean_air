<div class="panel panel-default sub-ticket-panel">
    ...
    if ($projectStatus == 1 || $projectStatus == 5 || $projectStatus == 2 || $projectStatus == 6 || $projectStatus == 10) {
        ...
        if (!empty($plDetail)){
            if(!empty($plDetail->staffid)){
                $psList .= '<option value="'.$plDetail->staffid .'">Own PL('. $plDetail->full_name . ')</option>';
            }
        }
    ...
    <?php if ($projectStatus == 1 || $projectStatus == 2 || $projectStatus == 5 || $projectStatus == 6 || $projectStatus == 10){
        ?>
...
<script>
            ...
            success: function(response) {
                ...
                if (response.success == true) {
                    if (milecount == 0 && rem1count == 0 && reminder1validity == 0 && reminder2validity == 0 && durationcount == 0) {
                        ...
                        $.ajax({
                            type: "post",
                            url: admin_url + "tickets/newissue",
                            data: data,
                            success: function(response) {
                                response = JSON.parse(response);
                                if (response.success == true) {
    ...
    function removeappendedNew(parent) {
        $("." + parent).remove();
    ...
    function postappend(parent,name) {
        x++;
        console.log(x);
        if (x > 0) {
            $('#filledmilestone0').attr('disabled', 'disabled');
        ...
        if(name && name != ''){
            ...
            var data = '<div class="milestone-row appendedfield' + x + '" ><input type="hidden" name="milesid[]" /><div class="form-input-field full-width"><input name="milestones[]" id="milestonename' + (x - 1) + '" type="text" value="'+name+'" disabled><label for="" title="<?php echo _l('milestone_name') ?>" data-title="Milestone Name"></label><span> <p id="milestone_span' + (x - 1) + '" style="color:red"></p></span></div><div class="form-input-field duration-field"><input  name="durations[]" onchange="changedefaultduration(event);changedurationonedit();"  id="milestoneduration' + (x - 1) + '" type="number" onblur=addreminder(' + (x - 1) + ') required="" ><label for="" title="<?php echo _l('duration_days') ?>" data-title="Duration(Days)"></label><span> <p id="durations_span' + (x - 1) + '" style="color:red"></p></span></div><div class="form-input-field duration-field r1"><input  name="reminder1[]" type="number" id="milestoner1' + (x - 1) + '" value=""><label for="" title="<?php echo _l('reminderdays_1'); ?>" data-title="Reminder 1(Days)"></label> <span> <p id="reminder1_span' + (x - 1) + '" style="color:red"></p></span></div><div class="form-input-field duration-field r2"><input  name="reminder2[]" type="number" id="milestoner2' + (x - 1) + '" value=""><label for="" title="<?php echo _l('reminderdays_2'); ?>" data-title="Reminder 2(Days)"></label> <span> <p id="reminder2_span' + (x - 1) + '" style="color:red"></p></span></div><div class="duration-field" ><span><i class="fa fa-minus-square-o btn-color remove_field fa-2x " onclick=removeappendedNew("appendedfield' + x + '") style="margin-top:6px" ></i><i class="fa fa-plus-square-o btn-color add_field_after_button fa-2x " onclick=postappend("appendedfield' + x + '","") style="margin-top:6px;margin-left:3px;" ></i></span></div></div>';

            $(".input_fields_wrap_filled").append(data);

            console.log(parent);


            // $("." + parent).after('<div class="milestone-row appendedfield' + x + '" id="'+countIds+'"><input type="hidden" name="milesid[]" /><div class="form-input-field full-width"><input name="milestones[]" id="milestonename' + (x - 1) + '" type="text" ><label for="" title="'+name+'" data-title="Milestone Name"></label><span> <p id="milestone_span' + (x - 1) + '" style="color:red"></p></span></div><div class="form-input-field duration-field"><input  name="durations[]" onchange="changedefaultduration(event);changedurationonedit();"  id="milestoneduration' + (x - 1) + '" type="number" onblur=addreminder(' + (x - 1) + ') required="" ><label for="" title="<?php echo _l('duration_days') ?>" data-title="Duration(Days)"></label><span> <p id="durations_span' + (x - 1) + '" style="color:red"></p></span></div><div class="form-input-field duration-field r1"><input  name="reminder1[]" type="number" id="milestoner1' + (x - 1) + '" value=""><label for="" title="<?php echo _l('reminderdays_1'); ?>" data-title="Reminder 1(Days)"></label> <span> <p id="reminder1_span' + (x - 1) + '" style="color:red"></p></span></div><div class="form-input-field duration-field r2"><input  name="reminder2[]" type="number" id="milestoner2' + (x - 1) + '" value=""><label for="" title="<?php echo _l('reminderdays_2'); ?>" data-title="Reminder 2(Days)"></label> <span> <p id="reminder2_span' + (x - 1) + '" style="color:red"></p></span></div><div class="duration-field" id="'+countIds+'"><span><i class="fa fa-minus-square-o btn-color remove_field fa-2x " onclick=removeappended("appendedfield' + x + '") style="margin-top:6px" ></i><i class="fa fa-plus-square-o btn-color add_field_after_button fa-2x " onclick=postappend("appendedfield' + x + '","") style="margin-top:6px;margin-left:3px;" ></i></span></div></div>');
    ...
    function edit_issue(invoker) {
        ...
        postappend("appendedfield"+(x+1),"Site Visit");
        postappend("appendedfield"+(x+1),"Estimate Preparation");
        postappend("appendedfield"+(x+1),"Budget/Tender Approval");
        postappend("appendedfield"+(x+1),"Work Order Issue");
        postappend("appendedfield"+(x+1),"Execution of Work");
        postappend("appendedfield"+(x+1),"1 open text");
