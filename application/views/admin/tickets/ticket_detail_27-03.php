...
<div class="content pT0">
    ...
    <div class="box-wrapper">
        ...
        <ul class="nav nav-tabs pull-left ticket-detail-tabs">
            <li class="active project-detail-list"><a href="#ticket-details" data-toggle="tab">Project Details</a></li>
            <li class="print-none project-history-list"><a class="" href="#ticket-history" data-toggle="tab">Project History</a></li>
        </ul>
                                    ...
                                    <ul class="detail-list issue-detail-list pR0">
                                        ...
                                        <?php if (!empty($project_id) && !empty($evidenceImages)) {
                                            ...
                                            <ul class="nav nav-tabs ticket-detail-tabs w100P pL15 mB15">
                                                <li class="<?= $imageActive ?> print-none"><a href="#image" data-toggle="tab">Image(s) & Document(s)</a></li>
                                        ...
                                        <ul class="d-flex w100P raisedComment">
                                            <li class="w100P mT20 pL15 pR15 mR0" style="padding:14px;border-top:1px solid #ddd;border-right:1px solid #ddd;margin-top:0 !important"><label style="font-size:13px; font-weight:700; color: #2d2d2d;">Raised Comment</label><span><?php echo !empty($ticketDetails->description) ? $ticketDetails->description : ''; ?></span></li>
                                            <li class="w100P mT20 pL15 pR15 mR0" style="padding:14px;border-top:1px solid #ddd;border-right:1px solid #ddd;margin-top:0 !important"><label style="font-size:13px; font-weight:700; color: #2d2d2d;">Closed Comment</label><span><?php echo !empty($projectClosedNotes->content) ? $projectClosedNotes->content : ''; ?></span></li>
                                            <li class="w100P mT20 pL15 pR15 mR0" style="padding:14px; border-top:1px solid #ddd;border-right:1px solid #ddd;margin-top:0 !important"><label style="font-size:13px; font-weight:700; color: #2d2d2d;">QC Verified Comment</label><span><?php echo !empty($projectVerifiedNotes->content) ? $projectVerifiedNotes->content : ''; ?></span></li>
                                        </ul>
                                    </ul>
                                </div>
                            </div>
