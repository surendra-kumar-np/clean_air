        ...
        <ul class="detail-list issue-detail-list pR0">
            ...
            <?php if (!empty($project_id) && !empty($evidenceImages)) {
                ...
                <ul class="nav nav-tabs ticket-detail-tabs w100P pL15">
                    <li class="active print-none"><a href="#raisedImage" data-toggle="tab">Image(s) & Document(s)</a></li>
                ...
                <ul class="nav nav-tabs only-print">
                    <li class="" style="font-size: 14px; font-weight: 700; margin-top:15px;">Image(s) & Document(s)</li>
                </ul>
