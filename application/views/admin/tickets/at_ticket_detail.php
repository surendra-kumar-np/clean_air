            ...
            foreach ($allPlList as $plList) {
                if(!empty($plList['staffid'])){
                    if($plList['staffid'] != $userId){
                        ...
                        $plname = $plList['full_name'].'('.$plList['designation'].'-'.$plList['organisation'].')';
        ...
        <div class="create-dropdown pT0">
            <div class="row">
                <div class="col-lg-12 action-ticket-btn">
                    ...
                    <label class="btn-container"><a href="javascript:void(0)" class="semibold btn accept-btn close-ticket" data-ticketdetail="ticketDetail" data-projectid="<?php echo $project_id; ?>"><?php echo _l('close'); ?></a>
                    </label>
                    <?php } ?>
                    <label class="btn-container"><a href="javascript:void(0)" class="semibold btn reject-btn reopen-ticket mL5" data-projectid="<?php echo $project_id; ?>"><?php echo _l('reopen'); ?></a>
                    </label>
                </div>
