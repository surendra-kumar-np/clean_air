                ...
                <div class="panel-group" id="accordion-cat-1">
                    <div class="panel panel-default">
                        ...
                        <div id="basic-details" class="panel-collapse ">
                            <div class="panel-body pB0">
                                ...
                                <p class="reported-detail"><?php echo _l('this_reported_in');?> <span class="font-size-14"><?php echo $region; ?></span>, <span class="font-size-14"><?php echo $organization_name; ?></span>, <span class="font-size-14"><?php echo $subregion; ?></span>, <span class="font-size-14"><?php echo $ward_name; ?></span> <?php echo _l('near');?> <span class="font-size-14"><?php echo $landmark; ?></span> <?php echo _l('by');?> <span class="font-size-14"><?php echo $source; ?></span></p>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($tasks as $task) {
                                                            ...
                                                            if ($hasChild) {
                                                                ...
                                                                $assignedUserNamedesignation = !empty($assignedUserDetails->designation) ? $assignedUserDetails->designation : '';
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $assignedUserName ?>(<?php echo $assignedUserNamedesignation;?>)</td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <?php } ?>
                                                                    ...
                                                                    <ul class="lightgallery">
                                                                        ...
                                                                        $showevidence = true;
                                                                        $compare_date ='';
                                                                         //echo "<pre>";print_r($evidenceImageData['image'][0]['dateadded']);echo "</pre>";
                                                                         if(!empty($evidenceImageData['image'][0]['dateadded'])){
                                                                            $compare_date = $evidenceImageData['image'][0]['dateadded'];
                                                                         }
                                                                        foreach ($evidenceImageData['image'] as $k=>$imageData) {
                                                                            ...
                                                                            $datediff = 0; 
                                                                             //echo "<pre>";print_r($evidence_date[0]);echo $k."</pre>";
                                                                            ...
                                                                            if($imageData['staffid']!=0 && $roleId != 9 && (count($evidence_date)<=2 || $showevidence )){
                                                                                ...
                                                                                $no_img []= 1;
                                                                                 ...
                                                                                 //print_r($no_img);
                                                                                 if( $compare_date == $imageData['dateadded']){
                                                                        ?>
                                                                            <li style="border-right:none" class="text-center img_item" data-responsive="<?php echo base_url($imgPath . $file_name); ?>" data-src="<?php echo base_url($imgPath . $file_name); ?>">
                                                                                <a href="javascript:void(0);">
                                                                                    <figure>
                    ...
                    if ((($userRole == 'ata') && (get_staff_user_id() == $assignedUser)) && empty($sub_ticket_id)) {
                        ...
                        ?>
                            ...
                            <div class="box-wrapper mT30">
                                    
                                    <?php $this->load->view('admin/tickets/section/ata_ticket_detail_refer'); ?>
                            </div>
                        <?php }
                    }
                    ?>
