                                        ...
                                        <?php 
                                            ...
                                            ?>
                                                ...
                                                <ul class="nav nav-tabs w100P ticket-detail-tabs">
                                                    <li class="active print-none"><a href="#image_<?=$activity["id"]?>" data-toggle="tab">Image(s) & Document(s)</a></li>
                                                ...
                                                <div class="tab-content faq-cat-content">
                                                    <div class="panel-body pL0">
                                                        <div class="tab-content">
                                                            ...
                                                            <!-- Document -->
                                                            <div class="tab-pane <?= $docActive ?> fade" id="document_<?=$activity["id"]?>" style="display:none;">
                                                                <ul class="nav nav-tabs only-print">
