...
<style>
    /* Use a Hindi font */
    body {
        font-family: 'Material Icons'; /* Example using Google Fonts */
    }
</style>
    <table class=" header">
        <tr>
...
$address = !empty($ticketDetails->address) ? $ticketDetails->address : '';
    ...
    $organization_name =  !empty($ticketDetails->organization_name) ? $ticketDetails->organization_name : '';
    $ward_name =  !empty($ticketDetails->ward_name) ? $ticketDetails->ward_name : '';
    $source = !empty($ticketDetails->company) ? $ticketDetails->company : '';
    $userRole = $GLOBALS['current_user']->role_slug_url;
$serveyor_fname = !empty($ticketDetails->firstname) ? $ticketDetails->firstname : '';
$serveyor_lname = !empty($ticketDetails->lastname) ? $ticketDetails->lastname : '';
                                    ...
                                    <table class="mB15">
                                        <tr>
                                            <td>
                                                ...
                                                <p class="reported-detail">This has been reported in <span class="font-size-14"><?php echo $region; ?></span>,<span class="font-size-14"><?php echo $organization_name; ?></span>, <span class="font-size-14"><?php echo $subregion; ?></span>, <span class="font-size-14"><?php echo $ward_name; ?></span> near <span class="font-size-14"><?php echo $landmark; ?></span> by <span class="font-size-14"><?php echo $serveyor_fname.' '.$serveyor_lname; ?></span></p>
                                                <p class="reported-detail">Address : <?php echo $address;?></p>
                                                <p class="reported-detail">
                                                    Long Term: <strong class="font-size-14"> <?php if(isset($longterm) && $longterm == 1){
                                                        echo 'Yes';
                                                    } else {
                                                        echo 'No';
                                                    } ?></strong>
                                ...
                                <div id="issue-details" class="panel-collapse ">
                                    <div class="panel-body pL0 pR0">
                                        <div class="detail-list issue-detail-list pR0">
                                            ...
                                            <?php 
                                            // print_r($evidenceImages);
                                            
                                            if (!empty($project_id) && !empty($evidenceImages)) {
                                                ...
                                                <div class="content">
                                                    <h3 style="text-align: center;">Image(s) and Document(s)</h3>
                                                                        <h4 style="text-align: center;">Raised</h2>
                                                                ...
                                                                if (!empty($evidenceImageData['image'])) {
                                                                    ?>
                                                                        ...
                                                                        ?>
                                                                            <div style="width:100%">
                                                                        <a href="<?php echo base_url($imgPath . $file_optimized); ?>" target="_blank" style="width:100%; display:block;">
                                                                            <img style="width:100%;" src="<?php echo base_url($imgPath . $file_optimized); ?>" >
                                                                        </a>
                                                                        <?php echo $loc; ?>
                                                                        <p style="text-align:center;" ><?php echo 'Raised Comment : '. !empty($ticketDetails->description) ? $ticketDetails->description : ''; ?></p>
                                                                    </div>
                                                                        <?php }} ?>
                                                                ...
                                                                <?php   } else { 
                                                                    ...
                                                                    ?>
                                                                    <p class="text-warning text-center mT10"><i class="fa fa-warning"></i>No evidence image available</p>
                                                                <?php } ?>
                                                                ...
                                                                ?>
                                                                        ...
                                                                        <?php echo $loc; ?>
                                                                        <p style="text-align:center;" ><?php echo 'Raised Comment : '. !empty($ticketDetails->description) ? $ticketDetails->description : ''; ?></p><br/><br/>
                                                                    </div>
                                                                    <?php }}
                                                                } else { ?>
                                                                    <p class="text-warning text-center mT10"><i class="fa fa-warning"></i> No document available</p>
                                                                <?php } ?>
                                                                   
                                                                        <h4 style="text-align: center;" >Closed</h4>
                                                                        ...
                                                                        <?php echo $loc; ?>
                                                                        <p style="text-align:center;" ><?php echo 'Closed Comment : '. !empty($projectClosedNotes->content) ? @$projectClosedNotes->content : ''; ?></p>
                                                                    </div>
                                                                        <?php }else{
                                                            ...
                                                            <?php }
                                                                ...
                                                                <?php if (!empty($evidenceImageData['document'])) {
                                                                        ...
                                                                        <?php echo $loc; ?>
                                                                        <p style="text-align:center;" ><?php echo 'Closed Comment : '. !empty($projectClosedNotes->content) ? $projectClosedNotes->content : ''; ?></p><br/><br/>
                                                                    </div>
                                                                        <?php }}
                                                                        } else { ?>
                                                                                <p class="text-warning text-center mT10"><i class="fa fa-warning"></i> No document available</p>
                                                                ...
                                                                <h4 style="text-align: center;">QC Verified</h4>
                                                                        <?php if (!empty($evidenceImageData['image'])) { ?>
                                                                        ...
                                                                        <?php } ?>
                                                                        <?php echo $loc; ?>
                                                                        <p style="text-align:center;" > <?php echo 'Verified Comment : '. !empty($projectVerifiedNotes->content) ? $projectVerifiedNotes->content : ''; ?></p>
                                                                    </div>
                                                                            <?php }else{
                                                                        ...
                                                                        <?php echo $loc; ?>
                                                                        <p style="text-align:center;" ><?php echo 'Comment : '; !empty($projectVerifiedNotes->content) ? $projectVerifiedNotes->content : ''; ?></p><br/><br/>
                                                                    </div>
                                                                            <?php }}
                                                                            } else { ?>
                                                                                    <p class="text-warning text-center mT10"><i class="fa fa-warning"></i> No document available</p>
                                                    ...
                                                    <?php /*  if (!empty($evidenceImageData['image'])) { ?>
                                                                ...
                                                                ?>
                                                                    <div style="width:100%">
                                                                        ...
                                                                        <?php echo $loc; ?>
                                                                        <?php echo !empty($ticketDetails->description) ? $ticketDetails->description : ''; ?><br/><br/>
                                                                    </div>
                                                                <?php } ?>
                                                    <?php   } else { ?>
