                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" app-field-wrapper="projectsupport">
                                                        <div class="form-select-field">
                                                            ...
                                                            echo '<div id="leads-filter-status">';
                                                            echo render_select('projectsupport[]', $projectsupport, array('staffid', 'name'), '', $projectsupport, array('data-width' => '100%', 'data-none-selected-text' => _l('projectsupport'), 'multiple' => true, 'data-actions-box' => true), array(), 'no-mbot', '', false);
                                                            echo '</div>';
                                                            ?>
                ...
                $.post(admin_url + 'report/get_subregion', data).done((res) => {
                    ...
                    if (res.success == true) {
                        ...
                        res.data.actionReviewer.map(val => {
                            options2 += `<option value='${val.id}'>${val.name} </option>`;
                        });
