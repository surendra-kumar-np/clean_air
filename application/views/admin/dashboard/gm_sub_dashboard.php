                ...
                <div class="gm-table-container">
                    ...
                    <div class="table-scroll">
                        <table class="table gm-table gm-sub-table" style="margin-top: 6px;">
                            <thead>
                                <th width="140" class="sortIcon" onclick="sortTable('region_name', this)" data-order="asc">City</th>
                                ...
                                <th width="100" onclick="sortTable('reopen', this)" data-order="asc" class="reopen sortIcon"><?php echo _l('reopen'); ?></th>
                                <th width="120" onclick="sortTable('referred', this)" data-order="asc" class="wip sortIcon"><?php echo _l('referred'); ?></th>
                                
                                <th width="100" onclick="sortTable('longterm', this)" data-order="asc" class="longterm sortIcon"><?php echo _l('total_longterm'); ?></th>
                                <th width="120" onclick="sortTable('unassigned', this)" data-order="asc" class="unassigned sortIcon"><?php echo _l('total_unassigned'); ?></th>
                                <th width="90" onclick="sortTable('pendingforapp', this)" data-order="asc" class="pendingforapp sortIcon"><?php echo _l('total_pendingforapp'); ?></th>
                                <th width="90" onclick="sortTable('verified', this)" data-order="asc" class="verified sortIcon"><?php echo _l('Verify'); ?></th>
    ...
    function prepareTable(data, area) {
        ...
        data.forEach(status => {
            ...
            if (status.region_name != "") {
                table += `<td width="120">${status.region_name}</td><td width="80" data-area="${area}" data-status="1" data-region="${status.region_id}" class="filter-row">${status.new}</td><td width="100" data-area="${area}" data-status="7" data-region="${status.region_id}" class="filter-row">${status.close}</td><td width="120" data-area="${area}" data-status="2" data-region="${status.region_id}" class="filter-row">${status.reopen}</td><td width="80" data-area="${area}" data-status="3" data-region="${status.region_id}" class="filter-row">${status.referred}</td><td width="100" data-area="${area}" data-status="5" data-region="${status.region_id}" class="filter-row">${status.longterm}</td><td width="120" data-area="${area}" data-status="9" data-region="${status.region_id}" class="filter-row">${status.unassign}</td><td width="90" data-area="${area}" data-status="8" data-region="${status.region_id}" class="filter-row">${status.total_pendingforapp}</td><td width="70" data-area="${area}" data-region="${status.region_id}" class="filter-row">${status.verified}</td><td width="70" data-area="${area}" data-region="${status.region_id}" class="filter-row">${status.total}</td>`
                if (status.sub_region_status !== undefined && status.sub_region_status.length > 0) {
                    ...
                    status.sub_region_status.forEach(subStatus => {
                        table += `<tr><td width="140">${subStatus.sub_region_name}</td><td width="80" data-area="${area}" data-status="1" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.new}</td><td width="100" data-area="${area}" data-status="3" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.close}</td><td width="120" data-area="${area}" data-status="6" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.reopen}</td><td width="80" data-area="${area}" data-status="5" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.referred}</td>
                        <td width="100" data-area="${area}" data-status="10" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.longterm}</td><td width="120" data-area="${area}" data-status="9" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.unassign}</td><td width="90" data-area="${area}" data-status="11" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.total_pendingforapp}</td><td width="70" data-area="${area}" data-status="13" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.verified}</td><td width="70" data-area="${area}" data-status="7" data-region="${status.region_id}" data-subregion="${subStatus.sub_region_id}" class="filter-row">${subStatus.total}</td></tr>`
                    })
                    table += `</table></td>`;
                }
            }
