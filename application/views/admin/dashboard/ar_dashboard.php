		...
		<h2 class="action-head" style="text-align:right;"><?php //echo _l('summary'); ?> <a href="<?php echo admin_url('dashboard/mapview') ?>" class="gm-filter-container" style=" width:10%"><button class="" type="button"><?php echo _l('view_on_map'); ?></button></a></h2>
            ...
            <div class="total-issues-bg" onclick="reportFilter(7)">
                ...
                <!-- <div class="new">
                    ...
                    <div class="verified-bg">
                        <!-- <figure>
                            <img src="<?php echo base_url('assets/images/closed.png') ?>" alt="">
                        </figure> -->
                        <div class="verificationboxWrap">
                            <div class="verificationbox" onclick="reportFilter(13)">
                                <label class="verified_total">
                                    <?php echo $verified; ?>
                                </label>
                                <span><?php echo _l('verify'); ?></span>
                            </div>
                            <div class="verificationbox" onclick="reportFilter(4)">
                                <label class="verified_total">
                                        <?php echo $resolved; ?>
                                    </label>
                                    <span><?php echo _l('resolved'); ?></span>
                            </div>
                            <div class="verificationbox" onclick="reportFilter(16)">
                                <label class="verified_total">
                                        <?php echo $part_resolved; ?>
                                    </label>
                                    <span title="Partially Resolved"><?php echo _l('presolved'); ?></span>
                            </div>
                            <div class="verificationbox" onclick="reportFilter(15)">
                                <label class="verified_total">
                                        <?php echo $unresolved; ?>
                                    </label>
                                    <span><?php echo _l('unresolved'); ?></span>
                            </div>
