            ...
            if (in_array($userRole, [ 'ata', 'aa','qc','at'])) { ?>
                ...
                <ul class="nav nav-tabs dashboard-tab">
                    ...
                    <?php if($userRole != 'qc' && $userRole != 'ar'){ ?>
                        ...
                        class="action_items_cnt1"><?php echo (!empty($action_items_notview)) ? $action_items_notview : 0; ?>/</span><span id="thispageTablecount"><?php echo (!empty($action_items_cnt)) ? $action_items_cnt : 0; ?></span>)</a></li>
                    ...
                    <?php //echo $upcomingView;?> (<span class="upcoming_deadline_cnt">
                            ...
                            <li class="verified_data"><a href="#verified-deadlines" data-toggle="tab">
                                <?php echo $upcomingView;?> (<span class="verified_cnt">
                                    <?php echo (!empty($action_items_notview_verified)) ? $action_items_notview_verified : 0; ?>/</span><span id="verified_view_cnt"><?php echo (!empty($action_items_verified_cnt)) ? $action_items_verified_cnt : 0; ?></span>)</a>
                            </li>
