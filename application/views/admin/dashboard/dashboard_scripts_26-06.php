...
<script>
    ...
    function createPaginationRefer(totalPagesrefer, referpage) {
        ...
        if (referpage > 2) {
            liTagRef += `<li class="first numb" onclick="createPaginationRefer(totalPagesrefer, 1)"><span>1</span></li>`;
            if (referpage > 3) {
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
            ...
            liTagRef += `<li class="numb ${active}" onclick="createPaginationRefer(totalPagesrefer, ${plength})"><span>${plength}</span></li>`;
        }
        ...
        if (referpage < totalPagesrefer - 1) {
            ...
            liTagRef += `<li class="last numb" onclick="createPaginationRefer(totalPagesrefer, ${totalPagesrefer})"><span>${totalPagesrefer}</span></li>`;
        }
    ...
    if ($('#thispageTablecountpendingforapproval').length > 0) {
        ...
        function createPaginationsforapp(totalPagespendingforapproval, pendingforapprovalpage) {
            ...
            if (pendingforapprovalpage > 2) {
                liTagsfa += `<li class="first numb" onclick="createPaginationsforapp(${totalPagespendingforapproval}, 1)"><span>1</span></li>`;
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTagsfa += `<li class="numb ${active}" onclick="createPaginationsforapp(${totalPagespendingforapproval}, ${plength})"><span>${plength}</span></li>`;
            }
            ...
            if (pendingforapprovalpage < totalPagespendingforapproval - 1) {
                ...
                liTagsfa += `<li class="last numb" onclick="createPaginationsforapp(${totalPagespendingforapproval}, ${totalPagespendingforapproval})"><span>${totalPagespendingforapproval}</span></li>`;
            }
