                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="panel-header">
                            ...
                            ?>
                            <h1><?php echo _l('category_superadmin') ?><span><?php echo _l('here_you_can_view_add_edit_and_deactivate_action_items_and_milestones'); ?></span></h1>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="form-instruction add-title"><?php echo _l('here_you_can_introduce_a_new_action_item_by_filling_in_the_following_fields') ?></p>
                        <p class="form-instruction edit-title"><?php echo _l('here_you_can_edit_details_for_existing_action_items'); ?></p>
                        ...
                        <div class="form-group" app-field-wrapper="region_id">
                            <div class="form-select-field">
                                <select name="region_id[]" class="selectpicker show-tick" id="region_id" multiple data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" title="<?php echo _l('select_city_corporation_req');?>">
                                </select>
                        ...
                        <div class="form-group" app-field-wrapper="organization">
                            <div class="form-select-field">
                                <select name="organization_new[]" id="organization_new" multiple class="selectpicker show-tick"
                        ...
                        <div class="form-input-field"><input class="labellll-up" type="text" required="" id="issue_name" name="issue_name" value="<?php set_value('milestone_name'); ?>">
                            <label for="issue_name" title="<?php echo _l('action_item_name') ?>*" data-title="Category Name*"></label>
                            <span>
                ...
                <div class="notes mB20">
                    ...
                    <p class="form-field-notes mL0"> <?php echo _l('dftsmesodocmaapm_sodoapm') ?></p>
                    <p><?php echo _l('eiffph3moow1a2atpt') ?></p>
                    <ul>
                        <li><?php echo _l('raising_tender_takes_10_days'); ?>?></li>
                        <li><?php echo _l('clearing_section_of_road_takes_15_days'); ?></li>
                        <li><?php echo _l('end_of_Project'); ?></li>

                    </ul>
                    <p><?php echo _l('ttdwbfafat2mbwtfod'); ?></p>
                    <ul>
                        <li><?php echo _l('raising_tender_10_days'); ?></li>
                        <li><?php echo _l('clearing_section_of_road_5_days') ?></li>
                        <li><?php echo _l('end_of_project_15_days_by_formula'); ?></li>
                    </ul>
                </div>
                <!-- /.modal-content -->
                <?php echo form_close(); ?>
        ...
        <script>
            ...
            var PAGINATION_INFO = '<?php echo _l('showing'); ?> _START_ <?php echo _l('to'); ?> _TOTAL_ <?php echo _l('categories_at'); ?>';
            ...
            const validateActionItemname = (name) => {
                ...
                // if(/^[a-zA-Z ]+$/.test(name.trim()) == false){
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            if (milecount == 0 && rem1count == 0 && reminder1validity == 0 && reminder2validity == 0 && durationcount == 0) {
                                ...
                                $("#updated_csrf_token").val(response.updated_csrf_token); //use for header ajax token update. (not working properlly)

                                //$('#issue_form').append('<input type="text" name="csrf_token_name" value="'+response.updated_csrf_token+'" />');//testing
            ...
            function edit_issue(invoker, id) {
                ...
                var region_id = strtoarray($(invoker).data('region_id'));
                var organization_id = strtoarray($(invoker).data('organization_id'));
                ...
                if(region_id!=''){
                    ...
                    setTimeout(() => {
                        ...
                        $('#organization_new').selectpicker('val', organization_id);
