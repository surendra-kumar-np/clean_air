    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="form-instruction add-title"><?php echo _l('fill_in_the_following_fields_to_add_an_action_item'); ?></p>
                        ...
                        <div class="form-input-field"><input class="labellll-up" type="text" required="" id="issue_name" name="issue_name" value="<?php set_value('milestone_name'); ?>">
                            <label for="issue_name" title="<?php echo _l('action_item_req'); ?>" data-title="<?php echo _l('action_item_req'); ?>"></label>
                            <span>
