				...
				<div class="panel_s custom-panel">
					<div class="panel-body">
						<div class="panel-header">
							...
							<?php } ?>
							<h1><?php echo _l('manage_qc'); ?> <span><?php echo _l('here_you_can_view_add_edit_and_deactivate_qc'); ?> </span></h1>
						...
						$custom_fields = get_custom_fields('staff-qc', array('show_on_table' => 1));
						foreach ($custom_fields as $field) {
							array_push($table_data, $field['name']);
						}
						
						render_datatable($table_data, 'staff-qc');
						?>
						</div>
					</div>
				</div>
...
<div class="modal sidebarModal fade" id="add_area_admin" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<?php echo form_open(admin_url('staff/save_surveyor_qc')); ?>
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">
						<span class="edit-title"><?php echo _l('edit_qc');?></span>
						<span class="add-title"><?php echo _l('add_qc');?></span>
					</h4>
				</div>
				
				<div class="modal-body">
					<div id="addition"></div>
					<p class="form-instruction add-title"><?php echo _l('fill_in_the_following_fields_to_add_a_qc');?></p>
					<p class="form-instruction edit-title"><?php echo _l('fill_in_the_following_field(s)_to_edit_a_qc');?></p>
...
<script>
	$(function() {
		...
		initDataTable('.table-staff-qc', window.location.href, [3], [5], undefined, [0, 'asc'], '',columnDefs);
		...
		$.ajax({
			...
			success: function(res) {
				...
				if (res.success) {
					...
					$('.table-staff-qc').DataTable().ajax.reload();
