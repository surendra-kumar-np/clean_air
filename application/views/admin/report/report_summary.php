...
<table class=" header">
    ...
    <h2 class="text-center">Project Dashboard Summary</h2>
...
<thead>
    ...
    <th  class="new"><?php echo _l('in_progress'); ?></th>
                                    ...
                                    <th  class="closed"><?php echo _l('verified'); ?></th>
                                    <th  class="resolved"><?php echo _l('resolved'); ?></th>
                                    <th  class="p_resolved"><?php echo _l('pr_resolved'); ?></th>
                                    <th  class="escalated"><?php echo _l('unresolved'); ?></th>
