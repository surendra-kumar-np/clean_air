                    ...
                    <div class="panel-body">
                        <div class="panel-header">
                            <a href="#" onclick="new_area(); return false;" class="btn btn-custom add-area-admin pull-right display-block">
                               <?php echo  _l('add_exception'); ?>
                            </a>

                            <h1><?php echo _l('manage_exceptions')?><span><?php echo _l('here_you_can_view_add_edit_and_deactivate_exceptions');?></span></h1>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo  _l('edit_exception'); ?></span>
                    <span class="add-title"><?php echo  _l('add_exception'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div id="addition"></div>
                        <p class="form-instruction add-title"><?php echo _l('fill_in_the_following_field_to_add_an_exception')?></p>
                        <p class="form-instruction edit-title"><?php echo _l('fill_in_the_following_field_to_edit_an_exception')?></p>
                    </div>
                    <hr class="hr-panel-model" />
                </div>


                <?php echo render_input('name', _l('exception_name')); ?>
