				...
				<div class="panel_s">
					<div class="panel-body">
						<div class="panel-header">
							<a href="#" onclick="new_region(); return false;" class="btn btn-custom add-area-admin pull-right display-block">
								<?php echo _l('new_region'); ?>
							</a>

							<h1><?php echo _l('manage_city_corporation'); ?><span><?php echo _l('here_you_can_view_add_edit_and_deactivate_cities_corporations'); ?></span></h1>
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<div id="addition"></div>
						<p class="form-instruction add-title"><?php echo _l('here_you_can_create_a_new_city_corporation'); ?> </p>
						<p class="form-instruction edit-title"><?php echo _l('here_you_can_edit_the_city_corporation'); ?> </p>
						...
						<?php echo render_input('region_name', 'city_corporation_req'); ?>
